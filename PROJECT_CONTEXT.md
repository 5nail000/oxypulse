...
- Плитки датчиков, действия (HRV, КП Бутейко, практика Бутейко на тренажёре в модалках), тренды (~75 мин RAM, окна 2/5/10/60/75 мин, PNG текущего окна), WiFi-настройка, GPIO/Servo
...
- Веб-UI: датчики, действия (HRV, КП Бутейко, практика Бутейко на тренажёре), тренды (~75 мин RAM, PNG окна), WiFi, GPIO/Servo
...
**CO₂ (SCD41):** прогрев ~10 с; обновление раз в 5 с. FRC — вручную (UI/API). ASC — `SCD41_ASC_ENABLED` в `platformio.ini`. Компенсация инерции — `SCD41_CO2_DYNAMIC_COMP` и связанные флаги.
